package boardGameLibrary.views.gameBoard.cellMarker;

import boardGameLibrary.boardGame.pawn.PawnDisplayModel;
import boardGameLibrary.views.gameBoard.cellMarker.shapeMarkers.CircleMarker;
import boardGameLibrary.views.gameBoard.cellMarker.shapeMarkers.RectangleMarker;
import javafx.beans.property.DoubleProperty;
import javafx.scene.shape.Circle;
import javafx.scene.shape.Rectangle;
import javafx.scene.shape.Shape;
import boardGameLibrary.views.gameBoard.cellMarker.exceptions.InvalidCellMarkerShapeException;

/**
 * Used to mark a cell in the {@link boardGameLibrary.views.gameView.GameViewController}.
 *
