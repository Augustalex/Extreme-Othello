package boardGameLibrary.views.gameView;
...
import boardGameLibrary.views.utilities.DimensionBinder;
import boardGameLibrary.views.gameBoard.cell.Cell;
import boardGameLibrary.views.gameBoard.GameBoardFactory;
...
public class GameViewController extends FXMLViewController{
    ...
    public void bindContainerDimensionsToBoard(Pane boardContainer, Pane board){
        boardContainer.widthProperty().addListener((e) -> DimensionBinder.squareBindTo(board, boardContainer));
        boardContainer.heightProperty().addListener((e) -> DimensionBinder.squareBindTo(board, boardContainer));
        DimensionBinder.squareBindTo(board, boardContainer);
    }
    ...
    public void displayStats(GameMatch match){
        ...
        double margin = 0.05;
        DimensionBinder.bindWidthWithPadding(
                scoreStatsController.getPane(),
                statsContainer,
                DimensionBinder.margin(margin, margin)
        );
/*
